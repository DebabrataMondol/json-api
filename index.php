...
foreach ($results as  $single) {
  ?>
<div class="media"> <a href="" class="media-left"> <img alt="" src="https://via.placeholder.com/150"> </a>
<div class="media-body"> <a href="" class="catg_title"><?php echo $single['webTitle']; ?>
  
  <br>
  <p><b><?php echo $single['pillarName']; ?> | <?php echo $single['webPublicationDate']; ?></b></p>
</a> </div>
                </div>
